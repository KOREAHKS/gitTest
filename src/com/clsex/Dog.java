...
//	}
	...
	/*
	 * 메서드 오버라이딩(Overriding) : 상속받은 부모의 메서드의 내용부를 자식의 목적에 맞게 재정의 하는 것.
	 * 이때 주의해야 할 것은 
	 * 1. 접근제어자(public>protected>default>private) 가 부모와 같거나 더 커야 함.
	 * 2. 반드시 내용부만 재정의 되어야 하고, 파라미터나, 리턴타입등은 변경되어선 안됨.
	 * 만약, 변경이 되어진 경우엔 오버라이딩이 아니라 메서드를 추가한 것으로 간주됨 
	 */
	@Override //어노테이션.. 컴파일이나 실행시에 규칙을 체크하는 기법. 나중에 배움.
